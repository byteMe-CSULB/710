...
class _NavigationPageState extends State<NavigationPage> {
                                        ...
                                        itemBuilder:
                                          ...
                                          return Dismissible(
                                            ...
                                            onDismissed: (direction) {
                                              setState(() {
                                                if (_driver.displayName ==
                                                        contacts[index]
                                                            .displayName &&
                                                    _driver.phones.first.value
                                                            .toString() ==
                                                        contacts[index]
                                                            .phones
                                                            .first
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) => Chip(
                        ...
                        label: Text(contacts[index].displayName,
                            style: TextStyle(color: Colors.black)),
                        backgroundColor: (_driver.phones.first.value
                                    .toString() ==
  ...
  void addTrip() async {
    ...
    var passengers = [];
    HashMap passengersPaid = new HashMap<String, dynamic>();
    for (int i = 0; i < contacts.length; i++) {
      passengers.add(contacts[i].displayName);
      passengersPaid.putIfAbsent(contacts[i].displayName, () => false);
    }
